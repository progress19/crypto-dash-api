...
/*
        ...
        $key = '5jdKlfMvhNnYTdyWiJF3CY4UI7W7SiqEGgZwRxmEoZAqCvt2WmHw6wt31baIfdVs';
        $secret = 'xxx';

        $client = new \Binance\Spot(['key' => $key, 'secret' => $secret]);

        $response = $client->avgPrice('BTCUSDT');
        echo json_encode($response).'<br>';


        $response = $client->loanFlexibleLoanableData(['loanCoin' => 'AXS',]);
